...
import DataAssumptionsPage from "./pages/DataAssumptions";
...
export default function App() {
  ...
  return (
    <BrowserRouter>
      <div className="flex min-h-screen" data-station={station}>
        ...
        <main className="flex-1 p-5 max-w-[1600px]">
          ...
          <Routes key={station}>
            ...
            <Route path="/data-assumptions" element={<DataAssumptionsPage />} />
